...
function Footer() {
    return (
        <footer className='w-full min-h-[220px] container m-auto mx-8 md:px-24 py-4'>
            ...
            <div className='mt-32'>
                <Image onClick={()=>router.push("/")} width={45} height={45} alt="NNDYM Logo" className="cursor-pointer" src="/logo.svg" />
